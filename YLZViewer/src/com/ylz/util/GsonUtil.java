...
public class GsonUtil {
	...
	public static Gson getGson() {
		return new GsonBuilder()
				.registerTypeAdapter(int.class, GsonUtil.IntTypeAdapter)
				.registerTypeAdapter(Integer.class, GsonUtil.IntTypeAdapter)
				.registerTypeAdapter(long.class, GsonUtil.LongTypeAdapter)
				.registerTypeAdapter(Long.class, GsonUtil.LongTypeAdapter)
				.registerTypeAdapter(float.class, GsonUtil.FloatTypeAdapter)
				.registerTypeAdapter(Float.class, GsonUtil.FloatTypeAdapter)
				.create();
	}
	...
	public static TypeAdapter<Number> LongTypeAdapter = new TypeAdapter<Number>() {
	...
	public static TypeAdapter<Number> FloatTypeAdapter = new TypeAdapter<Number>() {
	...
	public static <T> T fromJson(String json, TypeToken<T> token,
		...
		try {
			...
			logger.error(json + " 无法转换为 " + token.getRawType().getName() + " 对象!",
					ex);
			return null;
		}
	}
