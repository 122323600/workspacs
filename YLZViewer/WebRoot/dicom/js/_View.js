    ...
    var windowView = (function () {
        ...
        return {
            ...
            windowSize: function (i, j) {
                ...
                _panel.find(".canvas-positioningLine,.canvas-lesionsPoint,.canvas-measure").attr({
                    "width": _panel.width(),
                    "height": _panel.height()
                });
        ...
        function boardFunctionPart() {
            return [{
                ...
                buttons: [
					...
					{display:true,id:"link",name:"联动",icon:"linkIcon",triggerSign:0},
					...
					{display:true,id:"pseudoColor",name:"伪彩",icon:"pseudoColorIcon",triggerSign:0},
    ...
    var seriesView = (function () {
        ...
        return {
            ...
            appendSeries: function (data) {
                ...
                dom.push('<p class="order-info-no">' + data.type + ':<span>');
                dom.push(data.type == 2 ? ++data.no : data.seriesNumber);
